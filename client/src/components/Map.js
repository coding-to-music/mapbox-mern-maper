      ...
      <div className="map__upper">
                        ...
                        >
                          <div className="map__popup">
                            ...
                            <div className="map__info">
                              ...
                              <p>
                                <strong>Visted on:</strong>{" "}
                                {new Date(visitDate).toLocaleDateString()}
                              </p>
                              {rating === 0 ? (
                                <p className="map__infoRating">
        ...
        <div className="map__right">
          <div className="map_rightHeader">
            ...
            <small>
              <strong>
                *Click on the Location Mark on map for more details..
              </strong>
            </small>
          </div>
